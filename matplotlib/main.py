...
plt.plot(df['Стоимость'], df['Потребление топлива'], 'bo-')
...
plt.figure(figsize=(8, 6))
plt.scatter(df['Максимальная скорость'], df['Потребление топлива'], c='r', marker='o')
...
plt.figure(figsize=(8, 6))
plt.scatter(df['Максимальная скорость'], df['Грузоподъемность'], c='g', marker='o')
plt.xlabel('Максимальная скорость')
...
plt.figure(figsize=(8, 6))
plt.hist(df['Максимальная скорость'], bins=5, edgecolor='black')
plt.xlabel('Максимальная скорость')
